...
import 'package:todolist/core/utils/pixel_sizer.dart';
...
abstract class CPaddings {
  ...
  static EdgeInsets vertical32 = EdgeInsets.symmetric(vertical: 32.ph);
  ...
  static EdgeInsets v28h31 =
  EdgeInsets.symmetric(vertical: 28.ph, horizontal: 31.pw);
  ...
  static EdgeInsets v12h8 =
  EdgeInsets.symmetric(vertical: 12.ph, horizontal: 8.pw);
  static EdgeInsets v8h16 =
  EdgeInsets.symmetric(vertical: 8.ph, horizontal: 16.pw);

  // all
  static EdgeInsets all2 =
  EdgeInsets.symmetric(vertical: 2.ph, horizontal: 2.pw);
  ...
  static EdgeInsets all34 =
  EdgeInsets.symmetric(vertical: 34.ph, horizontal: 34.pw);

  // only
  static EdgeInsets bottom4 = EdgeInsets.only(bottom: 4.ph);
  static EdgeInsets bottom6 = const EdgeInsets.only(bottom: 6);
  static EdgeInsets bottom8 = const EdgeInsets.only(bottom: 8);
  static EdgeInsets bottom10 = const EdgeInsets.only(bottom: 10);
  static EdgeInsets bottom16 = const EdgeInsets.only(bottom: 16);
  static EdgeInsets bottom22 = const EdgeInsets.only(bottom: 22);
  static EdgeInsets bottom24 = const EdgeInsets.only(bottom: 24);
  static EdgeInsets top16 = EdgeInsets.only(top: 16.ph);
  static EdgeInsets top24 = EdgeInsets.only(top: 24.ph);
  static EdgeInsets top80 = EdgeInsets.only(top: 80.ph);
}
